{
    ...
    description = "Create a nested hydra / deino of frequently accessed functions and macros!";
    inputs = rec {
    ...
    outputs = inputs@{ self, flake-utils, settings, ... }: with builtins; with settings.lib; with flake-utils.lib; settings.mkOutputs {
        ...
        callPackage = { emacs, pname }: emacs.pkgs.trivialBuild rec {
            ...
            propagatedUserEnvPkgs = with emacs.pkgs; flatten [ deino deino.propagatedUserEnvPkgs alloy ];
            meta = {
